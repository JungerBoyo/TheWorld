...
// configuration step. It creates a namespace called `TheWorld`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        TheWorld::cmake::project_name,
        TheWorld::cmake::project_version));// version string, acquired
